...
public final class BpmnModelConstants {
    ...
    public static final String BPMN_ATTRIBUTE_PARENT_ID = "parentId";
    ...
    public static final String BPMN_ATTRIBUTE_SOURCE_REFS = "sourceRefs";
    public static final String BPMN_ATTRIBUTE_TARGET_REFS = "targetRefs";
    ...
    public static final String BPMN_ATTRIBUTE_LOOP_CONDITION = "loopCondition";
    ...
    public static final String BPMN_EXT_ATTRIBUTE_METHOD = "method";

    public static final String BPMN_EXT_ATTRIBUTE_EXPRESSION = "expression";
    public static final String BPMN_EXT_ATTRIBUTE_PARAM_VAR = "paramVar";
    public static final String BPMN_EXT_ATTRIBUTE_RESULT_VAR = "resultVar";

    public static final String BPMN_EXT_ATTRIBUTE_COLLECTION = "collection";
    public static final String BPMN_EXT_ATTRIBUTE_ELEMENT_VAR = "elementVar";
    public static final String BPMN_EXT_ATTRIBUTE_ELEMENT_VAR_CLASS = "elementVarClass";
    public static final String BPMN_EXT_ATTRIBUTE_INDEX_VAR = "indexVar";

    public static final String BPMN_EXT_ATTRIBUTE_SUB_PROCESS_CODE = "subProcessCode";
}
